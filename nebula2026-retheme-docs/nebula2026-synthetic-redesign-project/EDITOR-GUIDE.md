...
description: "A quantum computer achieves consciousness..."
date: 2025-12-01
---
```
...
- `description` — teaser text shown in the story preview card; Hugo auto-summary is used if absent
...
- Add a `description` to each story (otherwise Hugo uses an auto-generated excerpt)
