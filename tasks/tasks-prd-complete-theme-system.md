...
- [x] 4.0 Phase 3: Content Migration
  ...
  - [x] 4.5 Verify homepage renders correctly with currentIssue theme
  - [x] 4.6 Verify archive page renders correctly
  - [x] 4.7 Spot-check 3-5 legacy issues for visual regressions

- [x] 5.0 Phase 4: Documentation & QA
  ...
  - [x] 5.7 Test all page types on mobile viewport
  - [x] 5.8 Final visual review of nebula2025 on all page types
  - [x] 5.9 Final visual comparison of horizon2020 vs production
  - [x] 5.10 Create before/after screenshots for documentation
